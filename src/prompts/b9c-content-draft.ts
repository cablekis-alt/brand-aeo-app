...
1-3. **브리프의 structure 순서를 그대로 따른다.** 브랜드가 뒤쪽 절에 놓여 있으면 앞 절을
   브랜드 이야기로 채우지 마라 — 앞 절은 브랜드 없이 읽히는 안내다. 브랜드명을 앞 절에 넣고
   싶어지면, 그 자리에 들어갈 말은 "어떤 숙소를 고를 때 무엇을 봐야 하는가"이지 우리 이름이 아니다.
